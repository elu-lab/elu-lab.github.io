...
v-app-bar(flat, color='indigo-darken-3', elevation=1, density="compact")
  template(v-slot:prepend): v-img(src="/favicon.png", height="28px", min-width="28px")
  v-app-bar-title
  ...
  template(v-slot:extension)
    ...
    v-tabs(fixed-tabs, center-active, v-model="tab")
      router-link.text-white.text-decoration-none(v-for="tab in tabs", :to="'/' + lang + tab.path", active-class="indigo-lighten-2")
